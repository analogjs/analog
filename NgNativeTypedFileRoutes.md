...
The most relevant references here are TanStack's search-validation guide in [`frameworks/tanstack/router-main/docs/router/how-to/validate-search-params.md`](frameworks/tanstack/router-main/docs/router/how-to/validate-search-params.md) and its shared navigation contract in [`frameworks/tanstack/router-main/docs/router/guide/navigation.md`](frameworks/tanstack/router-main/docs/router/guide/navigation.md): both treat navigation input and runtime-consumed route state as related but not identical concerns.
...
- TanStack Router references such as [`frameworks/tanstack/router-main/docs/router/guide/navigation.md`](frameworks/tanstack/router-main/docs/router/guide/navigation.md), [`frameworks/tanstack/router-main/docs/router/guide/link-options.md`](frameworks/tanstack/router-main/docs/router/guide/link-options.md), [`frameworks/tanstack/router-main/docs/router/guide/data-loading.md`](frameworks/tanstack/router-main/docs/router/guide/data-loading.md), and [`frameworks/tanstack/router-main/docs/router/how-to/validate-search-params.md`](frameworks/tanstack/router-main/docs/router/how-to/validate-search-params.md)
