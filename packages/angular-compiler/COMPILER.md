...
| `jit-transform.ts`    | JIT mode: decorator metadata arrays + constructor DI + signal downleveling + decorator removal (preserves `@Injectable` for self-registration) |
