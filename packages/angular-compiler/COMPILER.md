...
| `integration.spec.ts`           | 153   | Registry input/output extraction, cross-component binding, constant pool ordering, assignment precedence, templateUrl inlining, content projection, pipe chaining, template refs, two-way binding, computed signals, safe navigation, @defer triggers, @if alias, multi-component files, duplicate i0 prevention, OXC resource inlining, arrow object literal wrapping, .d.ts extraction, signal field preservation, decorator stripping, collectImportedPackages, non-Angular passthrough, template `<style>` merging, NgModule export expansion, member decorator removal, self-referencing components, .d.ts NgModule scanning, TS syntax preservation, lazy dependency arrays, directive compilation, recursive NgModule expansion, circular NgModule handling, HMR code generation (dynamic field copying, component/directive/pipe handling, local deps), sourcePackage sub-entry imports, sourcemap accuracy after type elision, hostDirectives metadata extraction (bare/object/forwardRef), emitExpr routing for function/method args, constant pool helpers survive type-only import elision, hoisted nested-template helpers (`*_Conditional_*_Template`) survive type-only import elision via `appendRight`, shared constants drift prevention, OXC-based AOT metadata, outputFromObservable registry scanning, nested JIT class support, JIT auto-import decorator classes for signal API downleveling, module-level string const `${var}` interpolation in metadata fields (template/selector/styles, single-level + chained, export const, let/var rejection, unresolvable fallback), signal input/model `alias` option (registry + compiled output, including aliased model `Change` event), signal/decorator query class predicates wrapped as R3QueryReference, tuple barrel registry + imports expansion (`export const X = [A, B] as const`), `usesInheritance` for `extends` clauses (InheritDefinitionFeature emission), abstract `@Directive()` (no selector), directive providers wrapped as LiteralArrayExpr, template literal `${var}` substitution preserves surrounding HTML quotes, host raw embedded quote preservation, `collectRelativeReExports`, signal query `read`/`descendants` options parsing, `@Inject(forwardRef(() => TOKEN))` unwrapping, output() / outputFromObservable() alias extraction in registry, `@Injectable` `useFactory`/`useClass`/`useExisting`/`useValue` provider configuration forwarded to compileInjectable, ambiguous union/intersection DI parameter rejection (T \| null still resolves to T), `@defer` deps emit `import().then(m => m.X)` and `m.default` for default imports (with per-block dedup), `hasTransform` flag on signal inputs in registry, declaration dedup across direct imports / tuple barrels / NgModule re-exports / self reference (avoids NG0300 from duplicate `dependencies: () => [...]` entries) |
| `i18n.spec.ts`                  | 6     | i18n template compilation: `$localize` emission, interpolation expressions, meaning/description metadata, `i18n-*` attribute bindings, ICU expressions, non-i18n passthrough                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `jit-integration.spec.ts`       | 19    | JIT transform preserves @Injectable for providedIn, JIT OXC ctorParameters (constructor DI, parameter decorators, parameterless skip), JIT OXC propDecorators (signal input/output/model/viewChild, @Input decorator, input transform preservation), JIT OXC resource rewriting (templateUrl/styleUrls/styleUrl ESM imports), JIT OXC class traversal (default export, directive)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `dts-reader.spec.ts`            | 7     | Directive/component/pipe extraction from `.d.ts`, signal inputs, aliased inputs, multiple classes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `component.spec.ts`             | 51    | All @Component features, signals (including required variants), control flow, defer, pipes, content projection, external resources, resource dependencies, providers, source maps, module-level string const `${var}` interpolation in inline templates (chained resolution + unresolvable fallback)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `ast-translator.spec.ts`        | 43    | Every AST visitor method (expressions + statements), ngDevMode global, i18n LocalizedString → $localize                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
