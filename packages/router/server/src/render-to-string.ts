/**
 * String-based SSR renderer with a cached platform — experimental.
 *
 * Uses a lightweight DOM shim and a custom string-based Renderer2
 * instead of full browser DOM emulation (Happy DOM / Domino), designed
 * for performance and edge runtime portability.
 *
...
export function renderToString(
  ...
  return async function render(
    ...
    let rendererFactory: StringRendererFactory2 | null = null;
      ...
      providers: [
        ...
        { provide: DOCUMENT, useValue: shimDocument },
        {
          ...
          useFactory: (sharedStylesHost: SharedStylesHost, appId: string) => {
            rendererFactory = new StringRendererFactory2(shimDocument, {
              sharedStylesHost,
              appId,
            });
