...
// devDependencies
export const V19_X_ANALOG_JS_PLATFORM = '^3.0.0-alpha.29';
export const V19_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^3.0.0-alpha.29';
export const V19_X_ANALOG_JS_VITEST_ANGULAR = '^3.0.0-alpha.29';
