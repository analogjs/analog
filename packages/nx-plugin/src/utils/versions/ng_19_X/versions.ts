// V19_X
export const V19_X_ANALOG_JS_ROUTER = '^2.0.0-alpha.5';
export const V19_X_ANALOG_JS_CONTENT = '^2.0.0-alpha.5';
...
// devDependencies
export const V19_X_ANALOG_JS_PLATFORM = '^2.0.0-alpha.5';
export const V19_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^2.0.0-alpha.5';
export const V19_X_ANALOG_JS_VITEST_ANGULAR = '^2.0.0-alpha.5';
