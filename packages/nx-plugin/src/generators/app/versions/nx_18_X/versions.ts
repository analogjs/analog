...
export const V18_X_ANALOG_JS_CONTENT = '^1.21.0-beta.4';
export const V18_X_ANALOG_JS_ROUTER = '^1.21.0-beta.4';
export const V18_X_ANALOG_JS_TRPC = '~0.3.0';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^1.21.0-beta.4';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^1.21.0-beta.4';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^1.21.0-beta.4';
