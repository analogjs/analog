// V18_X
// dependencies
export const V18_X_NX_DEVKIT = '^22.0.0';
export const V18_X_NX_ANGULAR = '^22.0.0';
export const V18_X_ANALOG_JS_CONTENT = '^2.4.0-beta.15';
export const V18_X_ANALOG_JS_ROUTER = '^2.4.0-beta.15';
export const V18_X_ANALOG_JS_TRPC = '~0.4.0';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^2.4.0-beta.15';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^2.4.0-beta.15';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^2.4.0-beta.15';
export const V18_X_ANGULAR_DEVKIT_BUILD_ANGULAR = '^21.0.0';
export const V18_X_NX_VITE = '^22.0.0';
export const V18_X_NX_LINTER = '^22.0.0';
