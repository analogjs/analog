...
export const V18_X_ANALOG_JS_CONTENT = '^2.8.0-beta.11';
export const V18_X_ANALOG_JS_ROUTER = '^2.8.0-beta.11';
export const V18_X_ANALOG_JS_TRPC = '~0.4.0';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^2.8.0-beta.11';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^2.8.0-beta.11';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^2.8.0-beta.11';
...
export const V18_X_VITE = '^6.4.0';
export const V18_X_VITE_TSCONFIG_PATHS = '^4.2.0';
export const V18_X_VITEST = '^5.0.0';
