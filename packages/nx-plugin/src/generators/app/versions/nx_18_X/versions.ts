...
export const V18_X_ANALOG_JS_CONTENT = '^2.6.2-beta.2';
export const V18_X_ANALOG_JS_ROUTER = '^2.6.2-beta.2';
export const V18_X_ANALOG_JS_TRPC = '~0.4.0';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^2.6.2-beta.2';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^2.6.2-beta.2';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^2.6.2-beta.2';
