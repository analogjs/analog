...
export const V18_X_ANALOG_JS_CONTENT = '^3.0.0-alpha.77';
export const V18_X_ANALOG_JS_ROUTER = '^3.0.0-alpha.77';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^3.0.0-alpha.77';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^3.0.0-alpha.77';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^3.0.0-alpha.77';
