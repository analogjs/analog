(() => {
  ...
  var A = (n, e) => {
    for (var t in e) Ur(n, t, { get: e[t], enumerable: !0 });
  };
  function U() {}
  function bt(n) {
    return n();
  ...
  function ie(n, e) {
    return (
      lt || (lt = document.createElement('a')), (lt.href = e), n === lt.href
    );
  }
  function vn(n) {
  ...
  var Hn =
    ...
    de = class {
      constructor(e) {
        (this.options = e),
          (this._listeners = 'WeakMap' in Hn ? new WeakMap() : void 0);
      }
      observe(e, t) {
        return (
  ...
  de.entries = 'WeakMap' in Hn ? new WeakMap() : void 0;
  var wn = !1;
  function Dr() {
    wn = !0;
  }
  ...
  function zn() {
    ...
    do {
      ...
      for (fe(null), re.length = 0, ne = 0; le.length; ) le.pop()();
  ...
  function Wr(n) {
    let e = [],
      t = [];
    se.forEach((r) => (n.indexOf(r) === -1 ? e.push(r) : t.push(r))),
      t.forEach((r) => r()),
      (se = e);
  }
  var it = new Set(),
  ...
  function jn(n, e, t, r, s, l, i, a, o, f, c, d) {
    let p = n.length,
      h = l.length,
      u = p,
      _ = {};
    ...
    for (u = h; u--; ) {
      let H = d(s, l, u),
        F = t(H),
        O = i.get(F);
      O ? r && M.push(() => O.p(H, e)) : ((O = f(F, H)), O.c()),
        b.set(F, (E[u] = O)),
        F in _ && T.set(F, Math.abs(u - _[F]));
    }
    let y = new Set(),
      X = new Set();
    function V(H) {
      D(H, 1), H.m(a, c), i.set(H.key, H), (c = H.first), h--;
    }
    for (; p && h; ) {
      let H = E[h - 1],
        F = n[p - 1],
  ...
  function me(n, e, t, r) {
    let { fragment: s, after_update: l } = n.$$;
    s && s.m(e, t),
      r ||
        Rt(() => {
          let i = n.$$.on_mount.map(bt).filter(at);
          n.$$.on_destroy ? n.$$.on_destroy.push(...i) : K(i),
            (n.$$.on_mount = []);
        }),
      l.forEach(Rt);
  }
  ...
  function Gr(n, e) {
    n.$$.dirty[0] === -1 && (re.push(n), Br(), n.$$.dirty.fill(0)),
      (n.$$.dirty[(e / 31) | 0] |= 1 << e % 31);
  }
  function Y(n, e, t, r, s, l, i, a = [-1]) {
    let o = he;
    fe(n);
    let f = (n.$$ = {
      fragment: null,
    ...
    if (
      ((f.ctx = t
        ? t(n, e.props || {}, (d, p, ...h) => {
            let u = h.length ? h[0] : p;
            return (
              f.ctx &&
                s(f.ctx[d], (f.ctx[d] = u)) &&
                (!f.skip_bound && f.bound[d] && f.bound[d](u), c && Gr(n, d)),
              p
            );
          })
        : []),
      ...
      if (e.hydrate) {
        Dr();
        let d = Lr(e.target);
        f.fragment && f.fragment.l(d), d.forEach(k);
  ...
  typeof HTMLElement == 'function' &&
    (Jr = class extends HTMLElement {
      ...
      connectedCallback() {
        let { on_mount: n } = this.$$;
        this.$$.on_disconnect = n.map(bt).filter(at);
  ...
  function ct(n, e = {}) {
    ...
    if (Yr.call(St, s)) {
      ...
      return (e.normalize === void 0 || e.normalize === null || e.normalize) &&
        typeof a == 'string'
        ? ct(a)
        : ((t[Dn.includes(s) ? 'regular' : 'irregular'] = r), t);
    }
    for (; I(s.charCodeAt(l)) && l < 9; ) l++;
    if (l > 1 && l < 9) {
      if (((t.language = r.slice(0, l)), l < 4)) {
        let a = 0;
        for (
          ;
          s.charCodeAt(l) === 45 &&
          ...
          t.extendedLanguageSubtags.push(r.slice(l + 1, l + 4)), (l += 4), a++;
        }
      }
      for (
        s.charCodeAt(l) === 45 &&
          ...
          I(s.charCodeAt(l + 4)) &&
          !I(s.charCodeAt(l + 5)) &&
          ((t.script = r.slice(l + 1, l + 5)), (l += 5)),
          s.charCodeAt(l) === 45 &&
            (I(s.charCodeAt(l + 1)) &&
            I(s.charCodeAt(l + 2)) &&
            !I(s.charCodeAt(l + 3))
              ? ((t.region = r.slice(l + 1, l + 3)), (l += 3))
              : $(s.charCodeAt(l + 1)) &&
                $(s.charCodeAt(l + 2)) &&
                $(s.charCodeAt(l + 3)) &&
                !$(s.charCodeAt(l + 4)) &&
                ((t.region = r.slice(l + 1, l + 4)), (l += 4)));
        s.charCodeAt(l) === 45;

      ) {
        let a = l + 1,
          o = a;
        for (; Z(s.charCodeAt(o)); ) {
          if (o - a > 7)
            return i(o, 1, 'Too long variant, expected at most 8 characters');
          o++;
        }
        if (o - a > 4 || (o - a > 3 && $(s.charCodeAt(a))))
          t.variants.push(r.slice(a, o)), (l = o);
        else break;
      }
      for (
        ;
        ...
        t.extensions.push({
          ...
          extensions: r.slice(l + 3, a).split('-'),
        }),
          (l = a);
      }
    } else l = 0;
    if (
      ...
      l = l ? l + 2 : 1;
      let a = l;
      for (; s.charCodeAt(a) === 45 && Z(s.charCodeAt(a + 1)); ) {
        let o = l + 1;
        for (a = o; Z(s.charCodeAt(a)); ) {
          if (a - o > 7)
            return i(
              a,
              5,
        ...
        t.privateuse.push(r.slice(l + 1, a)), (l = a);
      }
    }
    if (l !== r.length) return i(l, 6, 'Found superfluous content after tag');
    return t;
    function i(a, o, f) {
      return e.warning && e.warning(f, o, a), e.forgiving ? t : In();
    }
  }
  function In() {
    return {
    ...
    return {
      c() {
        i && i.c(),
          ...
          m(t, 'class', 'pagefind-ui__result-inner svelte-j9e30');
      },
      m(a, o) {
        i && i.m(a, o), S(a, e, o), S(a, t, o), R(t, r), R(t, s), R(t, l);
      },
      p(a, o) {
        a[0]
          ? i || ((i = Ln(a)), i.c(), i.m(e.parentNode, e))
          : i && (i.d(1), (i = null));
      },
      d(a) {
        i && i.d(a), a && k(e), a && k(t);
    ...
    return {
      c() {
        p && p.c(),
          ...
          m(s, 'href', (a = n[1].meta?.url || n[1].url)),
          m(r, 'class', 'pagefind-ui__result-title svelte-j9e30'),
          m(f, 'class', 'pagefind-ui__result-excerpt svelte-j9e30'),
          m(t, 'class', 'pagefind-ui__result-inner svelte-j9e30');
      },
      m(u, _) {
        p && p.m(u, _),
      ...
      p(u, _) {
        u[0]
          ? p
            ? p.p(u, _)
            : ((p = qn(u)), p.c(), p.m(e.parentNode, e))
          : p && (p.d(1), (p = null)),
          _ & 2 && l !== (l = u[1].meta?.title + '') && z(i, l),
          _ & 2 && a !== (a = u[1].meta?.url || u[1].url) && m(s, 'href', a),
          _ & 2 && c !== (c = u[1].excerpt + '') && (f.innerHTML = c),
          u[2].length
            ? h
              ? h.p(u, _)
              : ((h = Vn(u)), h.c(), h.m(t, null))
            : h && (h.d(1), (h = null));
      },
      d(u) {
        p && p.d(u), u && k(e), u && k(t), h && h.d();
      },
    };
  }
  function Ln(n) {
  ...
  function qn(n) {
    let e,
      t = n[1].meta.image && Bn(n);
    return {
      c() {
        (e = C('div')),
          t && t.c(),
          m(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30');
      },
      m(r, s) {
        S(r, e, s), t && t.m(e, null);
      },
      p(r, s) {
        r[1].meta.image
          ? t
            ? t.p(r, s)
            : ((t = Bn(r)), t.c(), t.m(e, null))
          : t && (t.d(1), (t = null));
      },
      d(r) {
        r && k(e), t && t.d();
  ...
  function Bn(n) {
    ...
    return {
      c() {
        (e = C('img')),
          m(e, 'class', 'pagefind-ui__result-image svelte-j9e30'),
          ie(e.src, (t = n[1].meta?.image)) || m(e, 'src', t),
          m(e, 'alt', (r = n[1].meta?.image_alt || n[1].meta?.title));
      },
      m(s, l) {
        S(s, e, l);
      },
      p(s, l) {
        l & 2 && !ie(e.src, (t = s[1].meta?.image)) && m(e, 'src', t),
          l & 2 &&
  ...
  function Vn(n) {
    let e,
      t = n[2],
      r = [];
    for (let s = 0; s < t.length; s += 1) r[s] = Wn(Pn(n, t, s));
    return {
      c() {
        e = C('ul');
        for (let s = 0; s < r.length; s += 1) r[s].c();
        m(e, 'class', 'pagefind-ui__result-tags svelte-j9e30');
      },
      m(s, l) {
        S(s, e, l);
      ...
      p(s, l) {
        if (l & 4) {
          ...
          for (i = 0; i < t.length; i += 1) {
            let a = Pn(s, t, i);
            r[i] ? r[i].p(a, l) : ((r[i] = Wn(a)), r[i].c(), r[i].m(e, null));
          }
    ...
    return {
      c() {
        (e = C('li')),
          ...
          (i = w(l)),
          (a = v()),
          m(e, 'class', 'pagefind-ui__result-tag svelte-j9e30'),
          m(e, 'data-pagefind-ui-meta', (o = n[8]));
      },
      m(f, c) {
        S(f, e, c), R(e, r), R(e, s), R(e, i), R(e, a);
      },
      p(f, c) {
        c & 4 && t !== (t = f[8].replace(/^(\w)/, Kn) + '') && z(r, t),
          c & 4 && l !== (l = f[9] + '') && z(i, l),
          c & 4 && o !== (o = f[8]) && m(e, 'data-pagefind-ui-meta', o);
      },
      d(f) {
        f && k(e);
      },
  ...
  function Qr(n) {
    ...
    return {
      c() {
        (e = C('li')), s.c(), m(e, 'class', 'pagefind-ui__result svelte-j9e30');
      },
      m(l, i) {
        S(l, e, i), s.m(e, null);
      },
  ...
  function xr(n, e, t) {
    let { show_images: r = !0 } = e,
      ...
      c = (d = 30) => '. '.repeat(Math.floor(10 + Math.random() * d));
    return (
      (n.$$set = (d) => {
        'show_images' in d && t(0, (r = d.show_images)),
          'process_result' in d && t(4, (s = d.process_result)),
          'result' in d && t(5, (l = d.result));
      }),
      (n.$$.update = () => {
        if (n.$$.dirty & 32) e: f(l);
      }),
  ...
  function Jn(n, e, t) {
    let r = n.slice();
    return (r[11] = e[t][0]), (r[12] = e[t][1]), r;
  }
  function Yn(n, e, t) {
    let r = n.slice();
    return (r[15] = e[t]), r;
    ...
    return {
      c() {
        i && i.c(),
          ...
          m(t, 'class', 'pagefind-ui__result-inner svelte-4xnkmf');
      },
      m(a, o) {
        i && i.m(a, o), S(a, e, o), S(a, t, o), R(t, r), R(t, s), R(t, l);
      },
      p(a, o) {
        a[0]
          ? i || ((i = Zn(a)), i.c(), i.m(e.parentNode, e))
          : i && (i.d(1), (i = null));
      },
      d(a) {
        i && i.d(a), a && k(e), a && k(t);
  ...
  function es(n) {
    let e,
      ...
      h = n[3],
      u = [];
    for (let E = 0; E < h.length; E += 1) u[E] = $n(Yn(n, h, E));
    let _ = n[2].length && er(n);
    return {
      c() {
        d && d.c(),
          (e = v()),
      ...
      p(E, b) {
        if (
          (E[0]
            ? d
              ? d.p(E, b)
              : ((d = Xn(E)), d.c(), d.m(e.parentNode, e))
            : d && (d.d(1), (d = null)),
          b & 2 && l !== (l = E[1].meta?.title + '') && z(i, l),
          b & 2 && a !== (a = E[1].meta?.url || E[1].url) && m(s, 'href', a),
          E[4]
            ? p
              ? p.p(E, b)
              : ((p = xn(E)), p.c(), p.m(t, f))
          ...
          for (T = 0; T < h.length; T += 1) {
            let M = Yn(E, h, T);
            u[T] ? u[T].p(M, b) : ((u[T] = $n(M)), u[T].c(), u[T].m(t, c));
          }
        ...
        E[2].length
          ? _
            ? _.p(E, b)
            : ((_ = er(E)), _.c(), _.m(t, null))
          : _ && (_.d(1), (_ = null));
      },
      d(E) {
        d && d.d(E), E && k(e), E && k(t), p && p.d(), Q(u, E), _ && _.d();
      },
    };
  }
  function Zn(n) {
  ...
  function Xn(n) {
    ...
    return {
      c() {
        (e = C('div')),
          t && t.c(),
          m(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf');
      },
      m(r, s) {
        S(r, e, s), t && t.m(e, null);
      },
  ...
  function Qn(n) {
    ...
    return {
      c() {
        (e = C('img')),
          m(e, 'class', 'pagefind-ui__result-image svelte-4xnkmf'),
          ie(e.src, (t = n[1].meta?.image)) || m(e, 'src', t),
          m(e, 'alt', (r = n[1].meta?.image_alt || n[1].meta?.title));
      },
      m(s, l) {
  ...
  function xn(n) {
    ...
    return {
      c() {
        (e = C('p')),
          m(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf');
      },
      m(r, s) {
        S(r, e, s), (e.innerHTML = t);
      },
      p(r, s) {
        s & 2 && t !== (t = r[1].excerpt + '') && (e.innerHTML = t);
      },
      d(r) {
        r && k(e);
      },
    ...
    return {
      c() {
        (e = C('div')),
          ...
          m(r, 'href', (i = n[15].url)),
          m(t, 'class', 'pagefind-ui__result-title svelte-4xnkmf'),
          m(o, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf'),
          m(e, 'class', 'pagefind-ui__result-nested svelte-4xnkmf');
      },
      m(c, d) {
        S(c, e, d),
          R(e, t),
      ...
      p(c, d) {
        d & 8 && s !== (s = c[15].title + '') && z(l, s),
          d & 8 && i !== (i = c[15].url) && m(r, 'href', i),
          d & 8 && f !== (f = c[15].excerpt + '') && (o.innerHTML = f);
      },
      d(c) {
        c && k(e);
      },
  ...
  function er(n) {
    let e,
      t = n[2],
      r = [];
    for (let s = 0; s < t.length; s += 1) r[s] = tr(Jn(n, t, s));
    return {
      c() {
        e = C('ul');
        for (let s = 0; s < r.length; s += 1) r[s].c();
        m(e, 'class', 'pagefind-ui__result-tags svelte-4xnkmf');
      },
      m(s, l) {
        S(s, e, l);
        for (let i = 0; i < r.length; i += 1) r[i] && r[i].m(e, null);
      ...
      p(s, l) {
        if (l & 4) {
          ...
          for (i = 0; i < t.length; i += 1) {
            let a = Jn(s, t, i);
            r[i] ? r[i].p(a, l) : ((r[i] = tr(a)), r[i].c(), r[i].m(e, null));
          }
          for (; i < r.length; i += 1) r[i].d(1);
          r.length = t.length;
        }
    ...
    return {
      c() {
        (e = C('li')),
          ...
          (i = w(l)),
          (a = v()),
          m(e, 'class', 'pagefind-ui__result-tag svelte-4xnkmf'),
          m(e, 'data-pagefind-ui-meta', (o = n[11]));
      },
      m(f, c) {
        S(f, e, c), R(e, r), R(e, s), R(e, i), R(e, a);
      },
      p(f, c) {
        c & 4 && t !== (t = f[11].replace(/^(\w)/, nr) + '') && z(r, t),
          c & 4 && l !== (l = f[12] + '') && z(i, l),
          c & 4 && o !== (o = f[11]) && m(e, 'data-pagefind-ui-meta', o);
      },
      d(f) {
        f && k(e);
      },
  ...
  function ts(n) {
    ...
    return {
      c() {
        (e = C('li')),
          s.c(),
          m(e, 'class', 'pagefind-ui__result svelte-4xnkmf');
      },
      m(l, i) {
        S(l, e, i), s.m(e, null);
      },
  ...
  function ns(n, e, t) {
    let { show_images: r = !0 } = e,
      ...
      c = !1,
      d = (u, _) => {
        if (u.length <= _) return u;
        let E = [...u]
          .sort((b, T) => T.locations.length - b.locations.length)
          .slice(0, 3)
          .map((b) => b.url);
        return u.filter((b) => E.includes(b.url));
      },
      p = async (u) => {
        t(1, (a = await u.data())),
          t(1, (a = s?.(a) ?? a)),
          t(2, (o = Object.entries(a.meta).filter(([_]) => !i.includes(_)))),
          Array.isArray(a.sub_results) &&
            (t(4, (c = a.sub_results?.[0]?.url === (a.meta?.url || a.url))),
            c
              ? t(3, (f = d(a.sub_results.slice(1), 3)))
              : t(3, (f = d([...a.sub_results], 3))));
      },
      h = (u = 30) => '. '.repeat(Math.floor(10 + Math.random() * u));
    return (
      (n.$$set = (u) => {
        'show_images' in u && t(0, (r = u.show_images)),
  ...
  function sr(n, e, t) {
    let r = n.slice();
    return (r[10] = e[t][0]), (r[11] = e[t][1]), (r[12] = e), (r[13] = t), r;
  }
  function lr(n, e, t) {
    let r = n.slice();
    return (r[14] = e[t][0]), (r[15] = e[t][1]), (r[16] = e), (r[17] = t), r;
  }
  function ir(n) {
    let e,
      t,
      r = n[4]('filters_label', n[5], n[6]) + '',
      s,
      l,
      i = Object.entries(n[1]),
      a = [];
    for (let o = 0; o < i.length; o += 1) a[o] = ur(sr(n, i, o));
    return {
      c() {
        (e = C('fieldset')), (t = C('legend')), (s = w(r)), (l = v());
        for (let o = 0; o < a.length; o += 1) a[o].c();
        m(t, 'class', 'pagefind-ui__filter-panel-label svelte-1v2r7ls'),
          m(e, 'class', 'pagefind-ui__filter-panel svelte-1v2r7ls');
      },
      m(o, f) {
        S(o, e, f), R(e, t), R(t, s), R(e, l);
        for (let c = 0; c < a.length; c += 1) a[c] && a[c].m(e, null);
      },
      p(o, f) {
        if (
          (f & 112 &&
            r !== (r = o[4]('filters_label', o[5], o[6]) + '') &&
            z(s, r),
          f & 143)
        ) {
          ...
          for (c = 0; c < i.length; c += 1) {
            let d = sr(o, i, c);
            a[c] ? a[c].p(d, f) : ((a[c] = ur(d)), a[c].c(), a[c].m(e, null));
          }
    ...
    return {
      c() {
        (e = C('div')),
          ...
          (h = w(')')),
          (_ = v()),
          m(t, 'class', 'pagefind-ui__filter-checkbox svelte-1v2r7ls'),
          m(t, 'type', 'checkbox'),
          m(t, 'id', (r = n[10] + '-' + n[14])),
          m(t, 'name', (s = n[10])),
          (t.__value = l = n[14]),
          (t.value = t.__value),
          (o.a = c),
          m(a, 'class', 'pagefind-ui__filter-label svelte-1v2r7ls'),
          m(a, 'for', (u = n[10] + '-' + n[14])),
          m(e, 'class', 'pagefind-ui__filter-value svelte-1v2r7ls'),
      ...
      m(M, y) {
        S(M, e, y),
          ...
          R(a, h),
          R(e, _),
          E || ((b = J(t, 'change', T)), (E = !0));
      },
      p(M, y) {
        (n = M),
          y & 2 && r !== (r = n[10] + '-' + n[14]) && m(t, 'id', r),
          y & 2 && s !== (s = n[10]) && m(t, 'name', s),
          y & 2 &&
            l !== (l = n[14]) &&
            ((t.__value = l), (t.value = t.__value)),
          y & 3 && (t.checked = n[0][`${n[10]}:${n[14]}`]),
          y & 2 && f !== (f = n[14] + '') && o.p(f),
          y & 2 && d !== (d = n[15] + '') && z(p, d),
          y & 2 && u !== (u = n[10] + '-' + n[14]) && m(a, 'for', u),
          y & 3 &&
            B(
              e,
  ...
  function ur(n) {
    let e,
      ...
      f,
      c,
      d = Object.entries(n[11] || {}),
      p = [];
    for (let h = 0; h < d.length; h += 1) p[h] = or(lr(n, d, h));
    return {
      c() {
        (e = C('details')),
          (t = C('summary')),
        ...
        (f = v()),
          m(t, 'class', 'pagefind-ui__filter-name svelte-1v2r7ls'),
          m(i, 'class', 'pagefind-ui__filter-group-label svelte-1v2r7ls'),
          m(l, 'class', 'pagefind-ui__filter-group svelte-1v2r7ls'),
          m(e, 'class', 'pagefind-ui__filter-block svelte-1v2r7ls'),
          (e.open = c = n[7] || n[3].map(_r).includes(n[10].toLowerCase()));
      },
      m(h, u) {
        S(h, e, u),
          R(e, t),
          ...
          (i.innerHTML = a),
          R(l, o);
        for (let _ = 0; _ < p.length; _ += 1) p[_] && p[_].m(l, null);
        R(e, f);
      },
      p(h, u) {
        if (
          (u & 2 &&
            r !== (r = h[10].replace(/^(\w)/, cr) + '') &&
            (t.innerHTML = r),
          u & 2 && a !== (a = h[10] + '') && (i.innerHTML = a),
          u & 7)
        ) {
          d = Object.entries(h[11] || {});
          let _;
          for (_ = 0; _ < d.length; _ += 1) {
            let E = lr(h, d, _);
            p[_] ? p[_].p(E, u) : ((p[_] = or(E)), p[_].c(), p[_].m(l, null));
          }
          for (; _ < p.length; _ += 1) p[_].d(1);
          p.length = d.length;
        }
        u & 138 &&
          c !== (c = h[7] || h[3].map(_r).includes(h[10].toLowerCase())) &&
          (e.open = c);
      },
      d(h) {
        h && k(e), Q(p, h);
  ...
  function ss(n, e, t) {
    let { available_filters: r = null } = e,
      ...
      d = !1;
    function p(h, u) {
      (f[`${h}:${u}`] = this.checked), t(0, f);
    }
    return (
      (n.$$set = (h) => {
        'available_filters' in h && t(1, (r = h.available_filters)),
          'show_empty_filters' in h && t(2, (s = h.show_empty_filters)),
  ...
  var ls = 'Jan Claasen <jan@cloudcannon.com>',
    is = '',
    as = 'ltr',
    os = {
      placeholder: 'Soek',
    ...
    us = { thanks_to: ls, comments: is, direction: as, strings: os };
  var Ht = {};
  A(Ht, {
    comments: () => _s,
    default: () => hs,
  ...
  var cs = 'Jermanuts',
    ...
    hs = { thanks_to: cs, comments: _s, direction: fs, strings: ds };
  var wt = {};
  A(wt, {
    comments: () => ps,
    default: () => Rs,
  ...
  var ms = 'Maruf Alom <mail@marufalom.com>',
    ps = '',
    gs = 'ltr',
    Es = {
      placeholder:
    ...
    Rs = { thanks_to: ms, comments: ps, direction: gs, strings: Es };
  var Ft = {};
  A(Ft, {
    comments: () => Ts,
    default: () => Ss,
  ...
  var bs = 'Pablo Villaverde <https://github.com/pvillaverde>',
    Ts = '',
    Cs = 'ltr',
    ks = {
      placeholder: 'Cerca',
    ...
    Ss = { thanks_to: bs, comments: Ts, direction: Cs, strings: ks };
  var Nt = {};
  A(Nt, {
    comments: () => As,
    default: () => Hs,
  ...
  var Ms = 'Dalibor Hon <https://github.com/dallyh>',
    As = '',
    ys = 'ltr',
    vs = {
      placeholder: 'Hledat',
    ...
    Hs = { thanks_to: Ms, comments: As, direction: ys, strings: vs };
  var zt = {};
  A(zt, {
    comments: () => Fs,
    default: () => Os,
  ...
  var ws = 'Jonas Smedegaard <dr@jones.dk>',
    Fs = '',
    Ns = 'ltr',
    zs = {
      placeholder: 'S\xF8g',
    ...
    Os = { thanks_to: ws, comments: Fs, direction: Ns, strings: zs };
  var Ot = {};
  A(Ot, {
    comments: () => Us,
    default: () => Ps,
  ...
  var js = 'Jan Claasen <jan@cloudcannon.com>',
    Us = '',
    Ds = 'ltr',
    Is = {
      placeholder: 'Suche',
    ...
    Ps = { thanks_to: js, comments: Us, direction: Ds, strings: Is };
  var jt = {};
  A(jt, {
    comments: () => qs,
    default: () => Ws,
  ...
  var Ls = 'Liam Bigelow <liam@cloudcannon.com>',
    qs = '',
    Bs = 'ltr',
    Vs = {
      placeholder: 'Search',
    ...
    Ws = { thanks_to: Ls, comments: qs, direction: Bs, strings: Vs };
  var Ut = {};
  A(Ut, {
    comments: () => Gs,
    default: () => Zs,
  ...
  var Ks = 'Pablo Villaverde <https://github.com/pvillaverde>',
    Gs = '',
    Js = 'ltr',
    Ys = {
      placeholder: 'Buscar',
    ...
    Zs = { thanks_to: Ks, comments: Gs, direction: Js, strings: Ys };
  var Dt = {};
  A(Dt, {
    comments: () => Qs,
    default: () => el,
  ...
  var Xs = 'Mikel Larreategi <mlarreaegi@codesyntax.com>',
    Qs = '',
    xs = 'ltr',
    $s = {
      placeholder: 'Bilatu',
      ...
      alt_search:
        'Ez dago emaitzarik [SEARCH_TERM] bilaketarentzat. [DIFFERENT_TERM] bilaketaren emaitzak erakusten',
      search_suggestion:
        'Ez dago emaitzarik [SEARCH_TERM] bilaketarentzat. Saiatu hauetako beste bateikin:',
      searching: '[SEARCH_TERM] bilatzen...',
    },
    el = { thanks_to: Xs, comments: Qs, direction: xs, strings: $s };
  var It = {};
  A(It, {
    comments: () => nl,
    default: () => ll,
  ...
  var tl = 'Ali Khaleqi Yekta <https://yekta.dev>',
    nl = '',
    rl = 'rtl',
    sl = {
      placeholder: '\u062C\u0633\u062A\u062C\u0648',
    ...
    ll = { thanks_to: tl, comments: nl, direction: rl, strings: sl };
  var Pt = {};
  A(Pt, {
    comments: () => al,
    default: () => cl,
  ...
  var _l = 'Nicolas Friedli <nicolas@theologique.ch>',
    fl = '',
    dl = 'ltr',
    hl = {
  ...
  var pl = 'Pablo Villaverde <https://github.com/pvillaverde>',
    gl = '',
    El = 'ltr',
    Rl = {
      placeholder: 'Buscar',
  ...
  var Tl = 'Nir Tamir <nirtamir2@gmail.com>',
    Cl = '',
    kl = 'rtl',
    Sl = {
      placeholder: '\u05D7\u05D9\u05E4\u05D5\u05E9',
    ...
    Ml = { thanks_to: Tl, comments: Cl, direction: kl, strings: Sl };
  var Vt = {};
  A(Vt, {
    comments: () => yl,
    default: () => wl,
  ...
  var Al = 'Amit Yadav <amit@thetechbasket.com>',
    yl = '',
    vl = 'ltr',
    Hl = {
      placeholder: '\u0916\u094B\u091C\u0947\u0902',
    ...
    wl = { thanks_to: Al, comments: yl, direction: vl, strings: Hl };
  var Wt = {};
  A(Wt, {
    comments: () => Nl,
    default: () => jl,
  ...
  var Fl = 'Diomed <https://github.com/diomed>',
    Nl = '',
    zl = 'ltr',
    Ol = {
      placeholder: 'Tra\u017Ei',
    ...
    jl = { thanks_to: Fl, comments: Nl, direction: zl, strings: Ol };
  var Kt = {};
  A(Kt, {
    comments: () => Dl,
    default: () => Ll,
  ...
  var Ul = 'Adam Laki <info@adamlaki.com>',
    Dl = '',
    Il = 'ltr',
    Pl = {
  ...
  var ql = 'Nixentric',
    ...
    Kl = { thanks_to: ql, comments: Bl, direction: Vl, strings: Wl };
  var Jt = {};
  A(Jt, {
    comments: () => Jl,
    default: () => Xl,
  ...
  var Gl = 'Cosette Bruhns Alonso, Andrew Janco <apjanco@upenn.edu>',
    Jl = '',
    Yl = 'ltr',
    Zl = {
      placeholder: 'Cerca',
    ...
    Xl = { thanks_to: Gl, comments: Jl, direction: Yl, strings: Zl };
  var Yt = {};
  A(Yt, {
    comments: () => xl,
    default: () => ti,
  ...
  var ni = 'Seokho Son <https://github.com/seokho-son>',
    ri = '',
    si = 'ltr',
    li = {
      placeholder: '\uAC80\uC0C9\uC5B4',
    ...
    ii = { thanks_to: ni, comments: ri, direction: si, strings: li };
  var Xt = {};
  A(Xt, {
    comments: () => oi,
    default: () => _i,
  ...
  var fi = 'Harry Min Khant <https://harrymkt.github.io>',
    di = '',
    hi = 'ltr',
    mi = {
      placeholder: '\u101B\u103E\u102C\u101B\u1014\u103A',
      ...
      load_more:
        '\u1014\u1031\u102C\u1000\u103A\u1011\u1015\u103A\u101B\u101C\u1012\u103A\u1019\u103B\u102C\u1038\u1000\u102D\u102F \u1010\u1004\u103A\u1015\u102B\u104B',
      search_label:
        '\u1024\u1006\u102D\u102F\u1000\u103A\u1010\u103D\u1004\u103A\u101B\u103E\u102C\u1016\u103D\u1031\u1015\u102B\u104B',
      filters_label:
        '\u1005\u1005\u103A\u1011\u102F\u1010\u103A\u1019\u103E\u102F\u1019\u103B\u102C\u1038',
      zero_results:
        '[SEARCH_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A\u1019\u103B\u102C\u1038 \u1019\u101B\u103E\u102D\u1015\u102B',
      many_results:
        '[SEARCH_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A [COUNT] \u1001\u102F',
      one_result:
        '[SEARCH_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A [COUNT]',
      alt_search:
        '[SEARCH_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A\u1019\u101B\u103E\u102D\u1015\u102B\u104B \u104E\u1004\u103A\u1038\u1021\u1005\u102C\u1038 [DIFFERENT_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A\u1019\u103B\u102C\u1038\u1000\u102D\u102F \u1015\u103C\u101E\u101E\u100A\u103A\u104B',
      search_suggestion:
        '[SEARCH_TERM] \u1021\u1010\u103D\u1000\u103A \u101B\u101C\u1012\u103A\u1019\u101B\u103E\u102D\u1015\u102B\u104B \u1021\u1031\u102C\u1000\u103A\u1015\u102B\u101B\u103E\u102C\u1016\u103D\u1031\u1019\u103E\u102F\u1019\u103B\u102C\u1038\u1011\u1032\u1019\u103E \u1010\u1005\u103A\u1001\u102F\u1000\u102D\u102F \u1005\u1019\u103A\u1038\u1000\u103C\u100A\u1037\u103A\u1015\u102B:',
      searching:
        '[SEARCH_TERM] \u1000\u102D\u102F \u101B\u103E\u102C\u1016\u103D\u1031\u1014\u1031\u101E\u100A\u103A...',
    },
  ...
  var Ci = 'Paul van Brouwershaven',
    ...
    Ai = { thanks_to: Ci, comments: ki, direction: Si, strings: Mi };
  var en = {};
  A(en, {
    comments: () => vi,
    default: () => Fi,
  ...
  var yi = 'Eirik Mikkelsen',
    ...
    wi = {
      ...
      one_result: '[COUNT] resultat for [SEARCH_TERM]',
      alt_search:
        'Ingen resultat for [SEARCH_TERM]. Viser resultat for [DIFFERENT_TERM] i staden',
      search_suggestion:
        'Ingen resultat for [SEARCH_TERM]. Pr\xF8v eitt av desse s\xF8keorda i staden:',
      searching: 'S\xF8ker etter [SEARCH_TERM]',
    },
    Fi = { thanks_to: yi, comments: vi, direction: Hi, strings: wi };
  var tn = {};
  A(tn, {
    comments: () => zi,
    default: () => Ui,
  ...
  var Ni = 'Christopher Wingate',
    ...
    Ui = { thanks_to: Ni, comments: zi, direction: Oi, strings: ji };
  var nn = {};
  A(nn, {
    comments: () => Ii,
    default: () => qi,
  ...
  var Bi = 'Jonatah',
    ...
    Gi = { thanks_to: Bi, comments: Vi, direction: Wi, strings: Ki };
  var sn = {};
  A(sn, {
    comments: () => Yi,
    default: () => Qi,
  ...
  var Ji = 'Bogdan Mateescu <bogdan@surfverse.com>',
    Yi = '',
    Zi = 'ltr',
    Xi = {
      placeholder: 'C\u0103utare',
  ...
  var ra = 'Andrija Sagicc',
    ...
    aa = { thanks_to: ra, comments: sa, direction: la, strings: ia };
  var on = {};
  A(on, {
    comments: () => ua,
    default: () => fa,
  ...
  var oa = 'Montazar Al-Jaber <montazar@nanawee.tech>',
    ua = '',
    ca = 'ltr',
    _a = {
      placeholder: 'S\xF6k',
  ...
  var ka = 'Patiphon Loetsuthakun <ptphon@gmail.com>',
    Sa = '',
    Ma = 'ltr',
    Aa = {
      placeholder: '\u0E04\u0E49\u0E19\u0E2B\u0E32',
      clear_search: '\u0E25\u0E49\u0E32\u0E07',
      load_more:
        '\u0E42\u0E2B\u0E25\u0E14\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E40\u0E15\u0E34\u0E21',
      search_label:
        '\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E1A\u0E19\u0E40\u0E27\u0E47\u0E1A\u0E44\u0E0B\u0E15\u0E4C',
      filters_label: '\u0E15\u0E31\u0E27\u0E01\u0E23\u0E2D\u0E07',
      zero_results:
        '\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A [SEARCH_TERM]',
      many_results:
        '\u0E1E\u0E1A [COUNT] \u0E1C\u0E25\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A [SEARCH_TERM]',
      one_result:
        '\u0E1E\u0E1A [COUNT] \u0E1C\u0E25\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A [SEARCH_TERM]',
      alt_search:
        '\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A [SEARCH_TERM] \u0E41\u0E2A\u0E14\u0E07\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E08\u0E32\u0E01\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32 [DIFFERENT_TERM] \u0E41\u0E17\u0E19',
      search_suggestion:
        '\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E1C\u0E25\u0E25\u0E31\u0E1E\u0E18\u0E4C\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A [SEARCH_TERM] \u0E25\u0E2D\u0E07\u0E04\u0E33\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E40\u0E2B\u0E25\u0E48\u0E32\u0E19\u0E35\u0E49\u0E41\u0E17\u0E19:',
      searching:
        '\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E49\u0E19\u0E2B\u0E32 [SEARCH_TERM]...',
    },
    ya = { thanks_to: ka, comments: Sa, direction: Ma, strings: Aa };
  var fn = {};
  A(fn, {
    comments: () => Ha,
    default: () => Na,
  ...
  var va = 'Taylan \xD6zg\xFCr Bildik',
    Ha = '',
    wa = 'ltr',
    Fa = {
      placeholder: 'Ara\u015Ft\u0131r',
    ...
    Na = { thanks_to: va, comments: Ha, direction: wa, strings: Fa };
  var dn = {};
  A(dn, {
    comments: () => Oa,
    default: () => Da,
  ...
  var za = 'Vladyslav Lyshenko <vladdnepr1989@gmail.com>',
    Oa = '',
    ja = 'ltr',
    Ua = {
      placeholder: '\u041F\u043E\u0448\u0443\u043A',
    ...
    Da = { thanks_to: za, comments: Oa, direction: ja, strings: Ua };
  var hn = {};
  A(hn, {
    comments: () => Pa,
    default: () => Ba,
  ...
  var Ia = 'Long Nhat Nguyen',
    ...
    Ba = { thanks_to: Ia, comments: Pa, direction: La, strings: qa };
  var mn = {};
  A(mn, {
    comments: () => Wa,
    default: () => Ja,
  ...
  var Va = 'Amber Song',
    ...
    Ja = { thanks_to: Va, comments: Wa, direction: Ka, strings: Ga };
  var pn = {};
  A(pn, {
    comments: () => Za,
    default: () => xa,
  ...
  var Ya = 'Amber Song',
    ...
    xa = { thanks_to: Ya, comments: Za, direction: Xa, strings: Qa };
  var gn = {};
  A(gn, {
    comments: () => eo,
    default: () => ro,
  ...
  var $a = 'Amber Song',
    ...
    ro = { thanks_to: $a, comments: eo, direction: to, strings: no };
  var so = [
      vt,
      Ht,
      wt,
  ...
  function pr(n) {
    ...
    return (
      ...
      (e = new fr({ props: l })),
      le.push(() => Un(e, 'selected_filters', s)),
      {
        c() {
          ut(e.$$.fragment);
        },
        ...
        p(i, a) {
          ...
          a[0] & 32 && (o.show_empty_filters = i[5]),
            ...
            !t &&
              a[0] & 1 &&
              ((t = !0), (o.selected_filters = i[0]), Nn(() => (t = !1))),
            e.$set(o);
        },
        i(i) {
          r || (D(e.$$.fragment, i), (r = !0));
        },
        o(i) {
          P(e.$$.fragment, i), (r = !1);
        },
    ...
    return (
      ...
      (r = i[t] = l[t](n)),
      {
        c() {
          (e = C('div')),
            r.c(),
            m(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3');
        },
        m(o, f) {
          S(o, e, f), i[t].m(e, null), (s = !0);
        },
        p(o, f) {
          let c = t;
          (t = a(o, f)),
  ...
  function io(n) {
    ...
    let u = n[13].results.length > n[17] && Rr(n);
    return {
      c() {
        (e = C('p')), d.c(), (t = v()), (r = C('ol'));
        for (let _ = 0; _ < s.length; _ += 1) s[_].c();
        (i = v()),
          u && u.c(),
          (a = x()),
          m(e, 'class', 'pagefind-ui__message svelte-e9gkc3'),
          m(r, 'class', 'pagefind-ui__results svelte-e9gkc3');
      },
      m(_, E) {
        S(_, e, E), d.m(e, null), S(_, t, E), S(_, r, E);
        for (let b = 0; b < s.length; b += 1) s[b] && s[b].m(r, null);
        S(_, i, E), u && u.m(_, E), S(_, a, E), (o = !0);
      },
      p(_, E) {
        c === (c = f(_, E)) && d
          ? d.p(_, E)
          : (d.d(1), (d = c(_)), d && (d.c(), d.m(e, null))),
          E[0] & 139292 &&
            ((p = _[13].results.slice(0, _[17])),
            ae(),
            (s = jn(s, E, h, 1, _, p, l, r, On, Er, null, mr)),
            oe()),
          _[13].results.length > _[17]
            ? u
              ? u.p(_, E)
              : ((u = Rr(_)), u.c(), u.m(a.parentNode, a))
            : u && (u.d(1), (u = null));
      },
      i(_) {
        if (!o) {
          for (let E = 0; E < p.length; E += 1) D(s[E]);
          o = !0;
        }
      },
      o(_) {
  ...
  function Er(n, e) {
    ...
    return (
      ...
      (s = o[r] = a[r](e)),
      {
        ...
        first: null,
        c() {
          (t = x()), s.c(), (l = x()), (this.first = t);
        },
        m(c, d) {
          S(c, t, d), o[r].m(c, d), S(c, l, d), (i = !0);
        },
        p(c, d) {
          e = c;
          let p = r;
    ...
    return {
      c() {
        (e = C('button')),
          (r = w(t)),
          m(e, 'type', 'button'),
          m(e, 'class', 'pagefind-ui__button svelte-e9gkc3');
      },
      m(i, a) {
        S(i, e, a), R(e, r), s || ((l = J(e, 'click', n[22])), (s = !0));
      },
      p(i, a) {
        a[0] & 524416 &&
    ...
    return {
      ...
      p(s, l) {
        l[0] & 589952 &&
          t !==
            (t =
              s[20]('searching', s[19], s[7]).replace(
                /\[SEARCH_TERM\]/,
                s[16],
              ) + '') &&
          z(r, t);
    ...
    return {
      c() {
        (e = C('div')),
          ...
          m(r, 'type', 'text'),
          m(r, 'placeholder', (s = n[20]('placeholder', n[19], n[7]))),
          m(r, 'title', (l = n[20]('placeholder', n[19], n[7]))),
          m(r, 'autocapitalize', 'none'),
          m(r, 'enterkeyhint', 'search'),
          (r.autofocus = n[8]),
          m(a, 'class', 'pagefind-ui__search-clear svelte-e9gkc3'),
          B(a, 'pagefind-ui__suppressed', !n[9]),
          m(d, 'class', 'pagefind-ui__drawer svelte-e9gkc3'),
          B(d, 'pagefind-ui__hidden', !n[15]),
          m(t, 'class', 'pagefind-ui__form svelte-e9gkc3'),
          m(t, 'role', 'search'),
          m(t, 'aria-label', (h = n[20]('search_label', n[19], n[7]))),
          m(t, 'action', 'javascript:void(0);'),
          m(e, 'class', 'pagefind-ui svelte-e9gkc3'),
      ...
      p(M, y) {
        (!u ||
          (y[0] & 524416 && s !== (s = M[20]('placeholder', M[19], M[7])))) &&
          m(r, 'placeholder', s),
          (!u ||
            (y[0] & 524416 && l !== (l = M[20]('placeholder', M[19], M[7])))) &&
            m(r, 'title', l),
          (!u || y[0] & 256) && (r.autofocus = M[8]),
          y[0] & 512 && r.value !== M[9] && Tt(r, M[9]),
          (!u || y[0] & 524416) &&
            o !== (o = M[20]('clear_search', M[19], M[7]) + '') &&
            z(f, o),
          (!u || y[0] & 512) && B(a, 'pagefind-ui__suppressed', !M[9]),
          M[12]
            ? b
              ? (b.p(M, y), y[0] & 4096 && D(b, 1))
              : ((b = pr(M)), b.c(), D(b, 1), b.m(d, p))
            : b &&
              (ae(),
              P(b, 1, 1, () => {
                b = null;
          ...
          M[15]
            ? T
              ? (T.p(M, y), y[0] & 32768 && D(T, 1))
              : ((T = gr(M)), T.c(), D(T, 1), T.m(d, null))
            : T &&
              (ae(),
              P(T, 1, 1, () => {
                T = null;
              ...
              oe()),
          (!u || y[0] & 32768) && B(d, 'pagefind-ui__hidden', !M[15]),
          (!u ||
            (y[0] & 524416 &&
              h !== (h = M[20]('search_label', M[19], M[7])))) &&
            m(t, 'aria-label', h),
          (!u || y[0] & 2) && B(e, 'pagefind-ui--reset', M[1]);
      },
      i(M) {
        u || (D(b), D(T), (u = !0));
      },
  ...
  var mo = (n) => n.preventDefault();
  function po(n, e, t) {
    let r = {},
      s = hr.map((g) => g.match(/([^\/]+)\.json$/)[1]);
    for (let g = 0; g < s.length; g++)
      r[s[g]] = { language: s[g], ...dr[g].strings };
    let { base_path: l = '/pagefind/' } = e,
      ...
      { excerpt_length: c } = e,
      { process_result: d = null } = e,
      { process_term: p = null } = e,
      { show_empty_filters: h = !0 } = e,
      { open_filters: u = [] } = e,
      { debounce_timeout_ms: _ = 300 } = e,
      { pagefind_options: E = {} } = e,
      { merge_index: b = [] } = e,
      { trigger_search_term: T = '' } = e,
      { translations: M = {} } = e,
      { autofocus: y = !1 } = e,
      { sort: X = null } = e,
    ...
    Ct(() => {
      let g = document?.querySelector?.('html')?.getAttribute?.('lang') || 'en',
        N = ct(g.toLocaleLowerCase());
      t(
        19,
        (Sn =
          r[`${N.language}-${N.script}-${N.region}`] ||
...
`),
      ...
      Sr = async () => {
        F &&
          ((kn = await F.filters()),
          (!ce || !Object.keys(ce).length) && t(18, (ce = kn)));
      },
      Mr = (g) => {
        let N = {};
        return (
      ...
      Ar = async (g, N) => {
        ...
        _ > 0 && g
          ? (_e && clearTimeout(_e),
            (_e = setTimeout(L, _)),
            await An(),
            F.preload(g, { filters: j }))
          : L(),
          vr();
      },
      An = async () => {
        for (; !F; ) Mn(), await new Promise((g) => setTimeout(g, 50));
      },
      yr = async (g, N) => {
        t(16, (Cn = g || '')),
      ...
      vr = () => {
        let g = W.offsetWidth;
        g != Cr && t(10, (O.style.paddingRight = `${g + 2}px`), O);
      },
      Hr = (g) => {
        g?.preventDefault(), t(17, (mt += i));
      },
      wr = (g) => {
        g.key === 'Escape' && (t(9, (H = '')), O.blur()),
          g.key === 'Enter' && g.preventDefault();
      };
    function Fr() {
      (H = this.value), t(9, H), t(23, T);
    }
    function Nr(g) {
      le[g ? 'unshift' : 'push'](() => {
        (O = g), t(10, O);
    ...
    return (
      (n.$$set = (g) => {
        'base_path' in g && t(25, (l = g.base_path)),
          ...
          'show_sub_results' in g && t(3, (f = g.show_sub_results)),
          'excerpt_length' in g && t(24, (c = g.excerpt_length)),
          'process_result' in g && t(4, (d = g.process_result)),
          'process_term' in g && t(27, (p = g.process_term)),
          'show_empty_filters' in g && t(5, (h = g.show_empty_filters)),
          'open_filters' in g && t(6, (u = g.open_filters)),
          'debounce_timeout_ms' in g && t(28, (_ = g.debounce_timeout_ms)),
          'pagefind_options' in g && t(29, (E = g.pagefind_options)),
          'merge_index' in g && t(30, (b = g.merge_index)),
          'trigger_search_term' in g && t(23, (T = g.trigger_search_term)),
          'translations' in g && t(7, (M = g.translations)),
          'autofocus' in g && t(8, (y = g.autofocus)),
          'sort' in g && t(31, (X = g.sort)),
          'selected_filters' in g && t(0, (V = g.selected_filters));
      }),
      (n.$$.update = () => {
        if (n.$$.dirty[0] & 8388608) e: T && (t(9, (H = T)), t(23, (T = '')));
        if (n.$$.dirty[0] & 513) e: Ar(H, V);
      }),
      [
        V,
        a,
  ...
  try {
    document?.currentScript &&
      document.currentScript.tagName.toUpperCase() === 'SCRIPT' &&
      (Rn = new URL(document.currentScript.src).pathname.match(
        /^(.*\/)(?:pagefind-)?ui.js.*$/,
      )[1]);
  } catch {
    Rn = '/pagefind/';
  ...
  var _t = class {
    constructor(e) {
      ...
      delete e.element,
        ...
        delete e.autofocus,
        delete e.sort;
      let T = t instanceof HTMLElement ? t : document.querySelector(t);
      T
        ? (this._pfs = new Tr({
            target: T,
            props: {
    ...
    triggerFilters(e) {
      ...
      for (let [r, s] of Object.entries(e))
        if (Array.isArray(s)) for (let l of s) t[`${r}:${l}`] = !0;
        else t[`${r}:${s}`] = !0;
