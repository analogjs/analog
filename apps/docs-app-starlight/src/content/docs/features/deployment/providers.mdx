...
If your project is not SSG Ready, set up your project for [Static Site Generation](/features/server/static-site-generation).
...
If your project is not SSR Ready, set up your project for [Server Side Rendering](/features/server/server-side-rendering).
...
[Deploying with a custom URL prefix](/features/deployment/overview#deploying-with-a-custom-url-prefix).
