...
In addition to the 5 primary types of routes, Analog also supports [Redirect Routes](/features/routing/metadata#redirect-routes) and [Content Routes](/features/routing/content).
