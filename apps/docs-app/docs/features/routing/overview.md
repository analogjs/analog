...
### Error: Invalid Configuration of Route

Ensure that `.page.ts` files are included in your typescript config. This setting is generated by default but may be missing if you installed Analog manually.
```ts
// /tsconfig.app.json
{
  /** Other Configs **/,
  "include": [/** Other Inclusions **/, "src/app/pages/**/*.page.ts"]
}
```
If this error occurs after adding a new page file to your application, restart your server and clear your browser cache.
