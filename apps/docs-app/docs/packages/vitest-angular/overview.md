---
title: Vitest Angular Package - Angular Testing with Vitest
description: Learn about the @analogjs/vitest-angular package for seamless Angular testing with Vitest. Includes custom builders, setup automation, and integration with Angular's testing infrastructure.
keywords:
  [
    'Vitest Angular',
    'Angular testing',
...
url: https://analogjs.org/docs/packages/vitest-angular/overview
type: documentation
author: Analog Team
publishedTime: '2022-01-01T00:00:00.000Z'
modifiedTime: '2024-01-01T00:00:00.000Z'
section: Packages
tags: ['vitest-angular', 'testing', 'angular', 'vitest']
---
...
The `@analogjs/vitest-angular` package provides a seamless testing experience for Angular applications using Vitest. It includes a custom builder that integrates Vitest with Angular's testing infrastructure.
