          ...
          @if (node.kind === 'doc') {
            ...
            <li class="mt-4">
              <button
                type="button"
                (click)="toggle(node)"
                class="flex w-full items-center justify-between rounded px-2 py-1 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
